	...
	<div class="container-width">
		<div class="row small-spacing">
          ...
          <div style="display: flex; border-bottom:solid 1px #ccc; margin-bottom: 15px">
            <h4 class="box-title" style="margin-top:16px; margin-right: 15px">Total Patients: <span>{{$tocount}}</span></h4>
            ...
            <tbody>
              @foreach($touser as $TodayUser)
							<tr>
								<td style="text-align:center">{{$TodayUser->name}}</td>
								<td style="text-align:center">{{$TodayUser->birthday}}</td>
								<td style="text-align:center">{{$TodayUser->gender}}</td>
								<td style="text-align:center">{{$TodayUser->phone}}</td>
								<td style="text-align:center">{{$TodayUser->email}}</td>
								<td style="text-align:center">{{$TodayUser->address}}</td>
                <td style="text-align:center">{{$TodayUser->language}}</td>
                <td style="text-align:center">{{$TodayUser->provider}}</td>
							</tr>
              @endforeach
						</tbody>
					</table>
